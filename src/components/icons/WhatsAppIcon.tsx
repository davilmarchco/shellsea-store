...
/** Official WhatsApp glyph (phone-in-bubble), as a single vector path.
 * Renders in `currentColor` — wrap in an element with `text-whatsapp` (brand
 * green) or `text-whatsapp-foreground` (white, for use on a green button). */
